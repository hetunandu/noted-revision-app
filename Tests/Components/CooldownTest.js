...
import Cooldown from '../../App/Components/Cooldown'

const wrapper = shallow(<Cooldown />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('Cooldown Component')) // That the Component Text is included
})
