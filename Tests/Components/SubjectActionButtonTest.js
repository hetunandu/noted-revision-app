...
import SubjectActionButton from '../../App/Components/SubjectActionButton'

const wrapper = shallow(<SubjectActionButton />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('SubjectActionButton Component')) // That the Component Text is included
})
