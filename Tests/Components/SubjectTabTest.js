...
import SubjectTab from '../../App/Components/SubjectTab'

const wrapper = shallow(<SubjectTab />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('SubjectTab Component')) // That the Component Text is included
})
